...
import software.amazon.location.sample.util.TEXT_TIME_FILTER
...
class MainActivitySignInTest {
    ...
    fun signInTest() {
        ...
        composeTestRule.waitUntil(DELAY_10000) {
            val isVisible = try {
                composeTestRule.onNodeWithTag(TEXT_TIME_FILTER).assertIsDisplayed()
                true
        ...
        composeTestRule.onNodeWithTag(TEXT_TIME_FILTER)
            .assertIsDisplayed()
    }
